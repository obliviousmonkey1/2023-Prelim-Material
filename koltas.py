...
class Dastan:
    def __init__(self, R, C, NoOfPiece, NoOfKoltas):
        self._Board = []
        self._Players = []
        ...
        self.__NoOfKoltas = NoOfKoltas -1
        self.__CreateMoveOptionOffer()
        self.__CreateBoard(self.__NoOfKoltas)
        self.__CreatePieces(NoOfPiece)
        self.__PlaceKoltas(NoOfPiece)
    ...
    def __CreateBoard(self, NoOfKoltas):
        p1 = NoOfKoltas
        p2 = NoOfKoltas
        for Row in range(1, self._NoOfRows + 1):
            for Column in range(1, self._NoOfColumns + 1):
    ...
    def __PlaceKoltas(self, NoOfKoltas):
        pass
